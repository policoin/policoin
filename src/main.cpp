...
uint256 hashGenesisBlock("0xca31804a05156ab9bb3b72373966fc8ad73375d196f7baf19286e49eb57f1adb");
...
const string strMessageMagic = "PoliCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // PoliCoin: 1 days
static const int64 nTargetSpacing = 120; // PoliCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal policoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PoliCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xca31804a05156ab9bb3b72373966fc8ad73375d196f7baf19286e49eb57f1adb");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1410913000; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 536239;

        if (fTestNet)
        {
            block.nTime    = 1410913000;
            block.nNonce   = 536239;
        }
